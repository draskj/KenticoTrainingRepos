<%@ Page Language="C#" AutoEventWireup="true"  Codebehind="Tab_DataCom.aspx.cs" MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" Title="Data.com" Inherits="CMSModules_ContactManagement_Pages_Tools_Contact_Tab_DataCom" Theme="Default" %>

<%@ Register Src="~/CMSModules/ContactManagement/Controls/UI/DataCom/ErrorSummary.ascx" TagName="ErrorSummary" TagPrefix="cms" %>
<%@ Register Assembly="CMS.DataCom.Web.UI" Namespace="CMS.DataCom.Web.UI" TagPrefix="cms" %>
