<%@ Page Language="C#" AutoEventWireup="true"  Codebehind="InsertEmailWidget.aspx.cs" Inherits="CMSModules_StrandsRecommender_Pages_InsertEmailWidget"
    ...
    <div class="InsertEmailWidget">
        <div class="InsertEmailWidgetHeader">
            <p>
                ...
                <asp:Literal runat="server" ID="litMoreInformation" />
            </p>
        </div>
    </div>
</asp:Content>
